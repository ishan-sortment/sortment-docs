...
3.  As you build your audience, you will see an count of your audience with current filters.<br>

    <figure><img src="../../.gitbook/assets/b8.png" alt=""><figcaption></figcaption></figure>
4.  As you build, click Preview data to verify the audience you're building is the intended one. Close the preview to back to the visual builder<br>
