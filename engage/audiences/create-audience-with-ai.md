...
Sortment's AI, makes audience creation incredibly intuitive and efficient. Instead of manually building complex filters, you can simply tell AI your audience requirements in plain language, and it will set up the audience for you.

**The streamlined process for creating an audience with AI:**

1. **Tell  AI your requirements:**
   * Start by engaging directly with your audience criteria. For instance, you could say:
     * "Create an audience of users who have at least one record in 'Ride Details' where 'Ride Date' is in the last 10 years, 'Ride Type' is 'Uber Black' (case-sensitive), and 'Ride Rating' is greater than 3."
   * AI will confirm its understanding and begin processing your request.

<figure><img src="../../.gitbook/assets/b2.png" alt=""><figcaption></figcaption></figure>

2. **Review the Auto-Populated Audience:**

* Once it has processed your request, it will automatically navigate you to the visual builder page.
* Here, you'll find the filters pre-populated based on your instructions. This allows you to visually inspect the logic and ensure it matches your intent.
...
<figure><img src="../../.gitbook/assets/b6 (2).png" alt=""><figcaption></figcaption></figure>
...
* AI automatically provides a name and description for the audience. However, you have the flexibility to change these to provide more context and clarity specific to your audience's purpose.
...
By leveraging Sortment AI, you can create highly targeted audiences with speed and accuracy, empowering your marketing efforts directly from your data warehouse.
